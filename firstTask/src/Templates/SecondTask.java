...
public class SecondTask implements GLEventListener {
...
//        drawCircle(gl, 100, Color.BLACK, true, 0, -150);
        gl.glColor3f(0.898f, 0.898f, 0.898f);
        drawCircle(gl, 70, true, 0, 0);
        gl.glColor3f(0.898f, 0.898f, 0.898f);
        drawCircle(gl, 50, true, 80, 10);
        gl.glColor3f(0.898f, 0.898f, 0.898f);
        drawCircle(gl, 50, true, -80, 10);
        gl.glColor3f(0.898f, 0.898f, 0.898f);
        drawCircle(gl, 50, true, 75, -35);
        gl.glColor3f(0.898f, 0.898f, 0.898f);
        drawCircle(gl, 50, true, -75, -35);
        
        gl.glColor3f(0.898f, 0.898f, 0.898f);
        drawCircle(gl, 50, true, 35, -35);
